...
main: src/main.c vector poly player1 player2 mainmenuscreen selectscreen gameplayscreen game
	gcc -o main src/main.c vector3.o polynomial.o mainmenuscreen.o selectscreen.o gameplayscreen.o game.o -lm -lraylib -lSDL2 -ldl -g
